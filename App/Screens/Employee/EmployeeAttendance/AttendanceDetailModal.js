...
export default function AttendanceDetailModal({
    ...
    console.log("addRejectedModal===>", addAttendanceDetailModal)
    ...
    return (
        <Modal
            transparent
            animationType="fade"
            visible={addAttendanceDetailModal}
            onRequestClose={() => {
                dispatch(changeAddAttendanceDetailModal(false))
            }}>
            <View
                ...
                <View style={
                    ...
                    >
                        <View style={{
                            ...
                            <TouchableOpacity
                                onPress={() => dispatch(changeAddAttendanceDetailModal(false))}
                                style={{ left: 60 }}
                            >
                                <Entypo
                                    name="cross"
