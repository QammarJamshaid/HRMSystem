...
import { useCreateCommitteMutation, useGetAllHodQuery } from './Services/CommitteeApi';
import Toast from 'react-native-toast-message';
function CreateCommitte(props) {
    ...
    const [CreateCommitte, { isLoading }] = useCreateCommitteMutation()
   
    
    const handleCreateCommittee = handleSubmit(async data => {
        console.log("data===>", data)

        let response = await CreateCommitte({
            CommitteeHead: item.Uid,
            CommitteeTitle:data.title,
